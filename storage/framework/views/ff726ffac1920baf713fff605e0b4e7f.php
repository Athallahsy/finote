...
<body>
    ...
    <div class="navbar-wrap">
        <nav class="navbar-custom">
            ...
            <div class="nav-right">
                ...
                <a href="<?php echo e(url('/register')); ?>" class="btn-ghost d-none d-sm-inline-flex">
    Register
</a>
                <a href="<?php echo e(url('/admin/login')); ?>" class="btn-premium d-none d-sm-inline-flex">
    ...
    <section class="hero-section">
        <div class="container">
            ...
            <div class="hero-cta-group reveal" style="transition-delay:.3s">
                <a href="<?php echo e(url('/register')); ?>" class="btn-premium">
    ...
    <section class="footer-cta">
        ...
        <div class="reveal" style="transition-delay:.2s">
            <a href="<?php echo e(url('/register')); ?>" class="btn-premium" style="font-size:1rem;padding:14px 32px">
...
<?php /**PATH C:\Users\user\Downloads\finote-patched\finote-main\resources\views/welcome.blade.php ENDPATH**/ ?>